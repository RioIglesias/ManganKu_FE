...
class SizeHelper {
  ...
  static Widget loading(
    ...
    return SizedBox(
      width: width ?? SizeHelper.setSp(20),
      height: height ?? SizeHelper.setSp(20),
      child: Center(
        child: CircularProgressIndicator(
          value: value,
          strokeWidth: 2.0,
          valueColor:
              AlwaysStoppedAnimation<Color>(color ?? ColorHelper.primary),
        ),
      ),
    );
  }
  ...
  static Widget divider({Color? color, double? thickness, double? height}) {
    return Divider(
      color: color,
      thickness: thickness,
      height: height ?? SizeHelper.setSp(30),
    );
  }
}
